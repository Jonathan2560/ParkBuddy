...
# Bookings from users
Reservation.create!(from: DateTime.new(2024, 3, 15, 8, 0), until: DateTime.new(2024, 3, 18, 10, 0), garage: garage1, user: user1)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 9, 0), until: DateTime.new(2024, 3, 18, 13, 0), garage: garage2, user: user2)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 13, 0), garage: garage3, user: user3)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 17, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage4, user: user4)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 14, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage5, user: user5)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage6, user: user6)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage7, user: user7)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage8, user: user8)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage9, user: user9)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage10, user: user10)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage11, user: user11)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage12, user: user12)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage13, user: user13)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage14, user: user14)
puts "reservation created"
Reservation.create!(from: DateTime.new(2024, 3, 15, 11, 0), until: DateTime.new(2024, 3, 18, 18, 0), garage: garage15, user: user15)
puts "reservation created"
puts "Seed done!"
